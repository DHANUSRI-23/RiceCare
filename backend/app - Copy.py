...
disease_model = tf.keras.models.load_model(
    r"C:\Crop Project Modified\Web_App\backend\paddy_disease_mobilenet.h5"
)

nutrient_model = tf.keras.models.load_model(
    r"C:\Crop Project Modified\Web_App\backend\paddy_nutrient_model.h5"
)

yield_model = pickle.load(open(r"C:\Crop Project Modified\Web_App\backend\yield_model.pkl", "rb"))
district_encoder = pickle.load(open(r"C:\Crop Project Modified\Web_App\backend\district_encoder.pkl", "rb"))
season_encoder = pickle.load(open(r"C:\Crop Project Modified\Web_App\backend\season_encoder.pkl", "rb"))
